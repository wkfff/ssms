 ...
 * 文件名称：ReviewTenantService2.java
 * 创建时间：2015-05-15
 * 创建用户：张铮彬
 */

package com.lanstar.service.government;
...
public class GovernmentTenantService extends TenantService {
    /**
     * 根据身份标识获取租户服务
     */
    public GovernmentTenantService( IdentityContext identityContext ) {
    ...
    public String buildSignature( String code ) {
        // 得到租户特征码：租户类型+县级编码
        String sign = TenantType.GOVERNMENT.getName().toUpperCase() + code;
