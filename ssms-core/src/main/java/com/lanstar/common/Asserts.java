...
public class Asserts {
    ...
    public static void notBlank( String text, String message, Object... params ) {
        if ( StrKit.isBlank( text ) ) throw new IllegalArgumentException( StrKit.format( message, params ) );
    }
    ...
    public static void notEmpty( String text, String message, Object... params ) {
        if ( text == null || text.length() == 0 )
            throw new IllegalArgumentException( StrKit.format( message, params ) );
    }
    ...
    public static void notNull( Object object, String message, Object... params ) {
        if ( object == null ) throw new IllegalArgumentException( StrKit.format( message, params ) );
    }
    ...
    public static void check( boolean flag, String message, Object... params ) {
        if ( flag ) throw new IllegalArgumentException( StrKit.format( message, params ) );
    }
    ...
    public static void outOfBounds( Object[] array, Integer index, String message, Object... params ) {
        if ( index == null || index <= 0 || index >= array.length ) {
            throw new ArrayIndexOutOfBoundsException( StrKit.format( message, params ) );
        }
    }
