 ...
 * 文件名称：EmailHandle.java
 * 创建时间：2015年7月14日 下午7:29:09
 * 创建用户：林峰
 */
...
public class EmailHandle {
    public static Logger log = Logger.getLogger( EmailHandle.class );
    /**邮件对象**/
    ...
    public boolean setContent(String mailContent){
        try {
    ...
    public boolean addFileAffix(String filename) {
        try {
            ...
            log.debug("增加邮件附件<" + filename + ">时发生错误：" + e);
            return false;
        }
