...
(
	...
	`R_CATEGORY`			VARCHAR(50)	 COMMENT '一级要素编码',
	`S_ CATEGORY`			VARCHAR(300)	 COMMENT '一级要素',
	`R_PROJECT`			VARCHAR(50)	 COMMENT '二级要素编码',
	`S_PROJECT`			VARCHAR(300)	 COMMENT '二级要素',
