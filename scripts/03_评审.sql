...
(
  ...
  `R_CATEGORY`   VARCHAR(300) COMMENT '类目',
  `S_CATEGORY`   VARCHAR(300) COMMENT '类目',
  `R_PROJECT`    VARCHAR(300) COMMENT '项目',
  `S_PROJECT`    VARCHAR(300) COMMENT '项目',
...
--自评报告模板表
DROP TABLE IF EXISTS SSM_GRADE_REPORT_TMP;
CREATE TABLE SSM_GRADE_REPORT_TMP
(

  `SID`          INT(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `P_PROFESSION` VARCHAR(32) NOT NULL COMMENT '专业编号',
  `S_PROFESSION` VARCHAR(100) COMMENT '专业',
  `C_CONTENT`       TEXT COMMENT '报告内容',
  `R_CREATE`     INT(11) COMMENT '创建人编号',
  `S_CREATE`     VARCHAR(50) COMMENT '创建人',
  `T_CREATE`     DATETIME COMMENT '创建时间',
  `R_UPDATE`     INT(11) COMMENT '更新人编号',
...
(
  ...
  `SID`          INT(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `R_SID`         INT(11) NOT NULL COMMENT '自评主表编号',
  `C_CONTENT`       TEXT COMMENT '报告内容',
  `R_CREATE`     INT(11) COMMENT '创建人编号',
  `S_CREATE`     VARCHAR(50) COMMENT '创建人',
  `T_CREATE`     DATETIME COMMENT '创建时间',
