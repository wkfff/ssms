...
(
	...
	`R_CREATE`		VARCHAR(32) COMMENT '创建人编号'	,
	`S_CREATE`		VARCHAR(100) COMMENT '创建人'	,
	...
	`R_TANENT`		INT(9) COMMENT '关联的租户'	,
	`P_TANENT`		CHAR(1) COMMENT '租户类型(E,R,G)'	,
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`R_TENANT`			VARCHAR(32)	 COMMENT '所属租户',
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`R_TENANT`			VARCHAR(32)	 COMMENT '企业编号',
	`C_ADDR`			VARCHAR(500)	 COMMENT '地址',
	`C_EMAIL`			VARCHAR(50)	 COMMENT '电子邮箱',
	`C_TEL`			VARCHAR(50)	 COMMENT '办公电话',
	`C_FAX`			VARCHAR(50)	 COMMENT '传真',
...
(
	...
	`S_LEVEL`			VARCHAR(50)	 COMMENT '机构级别',
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`R_TENANT`			VARCHAR(32)	 COMMENT '评审机构',
	`C_ADDR`			VARCHAR(500)	 COMMENT '地址',
	`C_EMAIL`			VARCHAR(50)	 COMMENT '电子邮箱',
	`C_TEL`			VARCHAR(50)	 COMMENT '办公电话',
	`C_FAX`			VARCHAR(50)	 COMMENT '传真',
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`R_TENANT`			VARCHAR(32)	 COMMENT '评审机构编号',
	`P_PROFESSION`			VARCHAR(32)	 COMMENT '专业编号',
	`S_PROFESSION`			VARCHAR(50)	 COMMENT '专业',
	`R_CREATE`		VARCHAR(32) COMMENT '创建人编号'	,
	`S_CREATE`		VARCHAR(100) COMMENT '创建人'	,
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`R_USER`			VARCHAR(32)	 COMMENT '操作用户',
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`C_NAME`			VARCHAR(100)	 COMMENT '参数名',
...
(
	...
	`C_VALUE`			VARCHAR(300)	 COMMENT '参数值',
	`R_PARENT`			VARCHAR(32)	 COMMENT '父级编号',
...
(
	...
	`SID`		INT(11) 	NOT NULL auto_increment COMMENT '自增主键',
	`R_NOTICE`			VARCHAR(32)	 COMMENT '通知公告',
	`C_CONTENT`			TEXT	 COMMENT '评论内容',
	`R_COMMENTS`			VARCHAR(32)	 COMMENT '引用评论',
...
(
	...
	`R_PARENT`			VARCHAR(32)	 COMMENT '上级分类',
