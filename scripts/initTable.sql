...
(
	...
	`R_CREATOR`		VARCHAR(32) COMMENT '创建人编号'	,
	`S_CREATOR`		VARCHAR(100) COMMENT '创建人'	,
	`T_CREATE`		TIMESTAMP COMMENT '创建时间'	,
	`R_UPDATE`		VARCHAR(32) COMMENT '更新人编号'	,
	`S_UPDATE`		VARCHAR(100) COMMENT '更新人'	,
	`T_UPDATE`		TIMESTAMP COMMENT '更新时间'	,
	`N_STATE`		INT COMMENT '状态'	,
	`N_INDEX`		INT COMMENT '排序'	,
	`N_VERSION`		INT COMMENT '版本'	,
	`C_NAME`			VARCHAR(500)	NOT NULL	 COMMENT '企业名称',
	`P_STATE`			VARCHAR(32)	 DEFAULT 1	 COMMENT '企业状态编号',
	`S_STATE`			VARCHAR(50)	 COMMENT '企业状态',
	`P_PROVINCE`			VARCHAR(32)	 COMMENT '省份编号',
	`S_PROVINCE`			VARCHAR(50)	 COMMENT '省份',
	`P_CITY`			VARCHAR(32)	 COMMENT '地市编号',
	`S_CITY`			VARCHAR(50)	 COMMENT '地市',
	`P_COUNTY`			VARCHAR(32)	 COMMENT '县市编号',
	`S_COUNTY`			VARCHAR(50)	 COMMENT '县市',
	...
	`S_NATURE`			VARCHAR(50)	 COMMENT '企业性质',
	...
	`S_LEVEL`			VARCHAR(50)	 COMMENT '当前达标等级',
...
(
	...
	`N_INDEX`		INT COMMENT '排序'	,
	`N_VERSION`		INT COMMENT '版本'	,
	`R_TENANT`			INT	 COMMENT '所属租户',
	`S_TENANT`			VARCHAR(100)	 COMMENT '所属租户名',
...
(
	...
	`N_VERSION`		INT COMMENT '版本'	,
	`R_TENANT`			INT	 COMMENT '企业编号',
	`P_PROFESSION`			INT	 COMMENT '专业编号',
	`S_PROFESSION`			VARCHAR(50)	 COMMENT '专业',
	PRIMARY KEY  (`SID`)
);
...
(
	...
	`C_SCOPE`			VARCHAR(500)	 COMMENT '评审业务范围',
	`P_LEVEL`			VARCHAR(32)	 COMMENT '评审业级别',
	`S_LEVEL`			VARCHAR(50)	 COMMENT '评审业级别',
...
(
	...
	`C_INSTUDRY`			VARCHAR(100)	 COMMENT '行业',
	`P_PROFESSION`			INT	 COMMENT '专业编号',
	`S_PROFESSION`			VARCHAR(100)	 COMMENT '专业',
	`N_YEAR`			INT	 COMMENT '现从事专业年限',
	`P_PROFESSION_L`			INT	 COMMENT '所学专业编号',
	`S_PROFESSION_L`			VARCHAR(100)	 COMMENT '所学专业',
...
(
	...
	`N_INDEX`		INT COMMENT '排序'	,
	`N_VERSION`		INT COMMENT '版本'	,
	`R_TENANT`			INT	 COMMENT '评审机构编号',
	`P_PROFESSION`			INT	 COMMENT '专业编号',
	`S_PROFESSION`			 	 COMMENT '专业',
	PRIMARY KEY  (`SID`)
);
...
(
	...
	`N_VERSION`		INT COMMENT '版本'	,
	`C_NAME`			VARCHAR(100)	 COMMENT '用户名',
	`P_SEX`			CHAR(1)	 DEFAULT 1	 COMMENT '性别',
...
(
	...
	`S_LEVEL`			VARCHAR(50)	 COMMENT '达标等级',
...
(
	...
	`N_INDEX`		INT COMMENT '排序'	,
	`N_VERSION`		INT COMMENT '版本'	,
	`R_NOTICE`			INT	 COMMENT '通知公告',
	`C_CONTENT`			TEXT	 COMMENT '评论内容',
	`R_COMMENTS`			INT	 COMMENT '引用评论',
	`Z_AUDIT`			CHAR(1)	 COMMENT '是否已审',
	PRIMARY KEY  (`SID`)
);
...
(
	...
	`N_INDEX`		INT COMMENT '排序'	,
	`N_VERSION`		INT COMMENT '版本'	,
	`C_NAME`			VARCHAR(500)	 COMMENT '名称',
	`R_SORT`			INT	 COMMENT '分类',
