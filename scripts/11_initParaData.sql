...
-- 初始化导航
INSERT INTO `SYS_NAV` (`SID`, `R_SID`, `C_NAME`, `C_URL`, `C_DESC`, `R_CREATE`, `S_CREATE`, `T_CREATE`, `R_UPDATE`, `S_UPDATE`, `T_UPDATE`, `R_TANENT`, `S_TANENT`, `P_TANENT`, `N_STATE`, `B_DELETE`, `N_INDEX`, `N_VERSION`)
VALUES
