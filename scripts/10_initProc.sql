...
SELECT R_SID,S_PROJECT,IFNULL(C_CONTENT,'') C_CONTENT,IFNULL(C_DESC,'') C_DESC FROM SSM_GRADE_E_D
WHERE IFNULL(N_SCORE_REAL,0)<IFNULL(N_SCORE,0) AND R_PROJECT<>'SUBTOTAL' AND R_PROJECT<>'TOTAL'
ORDER BY N_INDEX
