 ...
 * 文件名称：grade_reptmpController.java
 ...
 *
 */
public class grade_reptmpController extends DefaultController {

    public grade_reptmpController() {
    ...
    protected Class<? extends ActionValidator> getValidator() {
        return grade_reptmpValidator.class;
    }
}
