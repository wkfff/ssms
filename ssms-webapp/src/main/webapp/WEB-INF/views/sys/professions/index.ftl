<@layout.extends name="../../_layouts/base.ftl">
    ...
    <style type="text/css">
        ...
        .icon-refresh {
            background: url("/resource/images/reload.png") no-repeat 2px center;
            padding-left: 20px;
        }
    </style>
    </@>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="z-toolbar">
                ...
                <a href="javascript:void(0);" class="icon-refresh" data-bind="click: function () { location.href = '${BASE_PATH}'}">刷新</a>
            </div>
    ...
    <script type="text/javascript">
        function ViewModel() {
            ...
            self.cancelIndustry = function (model) {
                model.editable(false);
            };
            ...
            self.cancelProfession = function (model) {
                model.editable(false);
            };
