    ...
    <form class="form" method="post" style="padding: 10px 31px;">
     <table>
        ...
        <tr>
            <td>通知标题:</td>
            <td colspan="3"><input
                data-bind="disable: readonly, textboxValue: C_NAME"
                required /></td>
        </tr>
        ...
        <tr>
            <td>通知编号:</td>
            <td colspan="3"><input
                data-bind="disable: readonly, textboxValue: C_NUMBER"
                required /></td>
        </tr>

        <tr>
            <td colspan="4"><textarea
                    data-bind="htmleditValue: htmlContent, htmleditOptions:htmleditSettings"
                    style="width: 100%; min-height: 400px"></textarea></td>
        </tr>

        <tr>
            <td>发布部门:</td>
            <td><input
                data-bind="disable: readonly, textboxValue: C_DEPT_01"
                required /></td>
            <td>发布日期:</td>
            <td><input
                data-bind="disable: readonly, dateboxValue: T_DATE_01"
                required /></td>
        </tr>
        ...
        <tr>
            <td>主送部门:</td>
            <td><input
                data-bind="disable: readonly, textboxValue: C_DEPT_02" />
            </td>

            <td>抄送部门:</td>
            <td><input
                data-bind="disable: readonly, textboxValue: C_DEPT_03" />
            </td>
        </tr>
      </table>
    </form>
