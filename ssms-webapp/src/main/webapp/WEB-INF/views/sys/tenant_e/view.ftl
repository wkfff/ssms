...
<div class="easyui-panel">
    <form class="form" style="padding: 20px">
        <div class="easyui-panel" style="padding:10px" border="false" title="基本信息" collapsible="true">
            <p class="ue-clear">
                <label>租户编码</label>
                <span class="control">
            ...
            <p class="long-input ue-clear">
                <label>企业名称</label>
                <span class="control">
                    <input class="readonly" value="${C_NAME}"  readonly/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>行业</label>
                <span class="control">
                    <input data-bind="disable:true,comboboxValue:R_INDUSTRY,easyuiOptions:industrySetting" />
                </span>
            </p>
        ...
        <div class="easyui-panel form" style="padding:10px" title="联系方式" border="false" collapsible="true">
            <p class="long-input ue-clear">
                <label>电子邮箱</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_EMAIL" required/>
                </span>
            </p>
            ...
            <p class="long-input ue-clear">
                <label>地址</label>
                <span class="control">
                    <input style="width: 60px" data-bind="disable:true,comboboxValue:P_PROVINCE,comboboxText:S_PROVINCE,easyuiOptions:provinceSetting" required/>省
                    <input style="width: 60px" data-bind="disable:true,comboboxValue:P_CITY,comboboxText:S_CITY,easyuiOptions:citySetting" required/>市
                    <input style="width: 60px" data-bind="disable:true,comboboxValue:P_COUNTY,comboboxText:S_COUNTY,easyuiOptions:countySetting" required/>区(县)
                    <input style="width: 400px" data-bind="disable:true,textboxValue: C_ADDR" required/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>联系人</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_CONTACT" required/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>固话</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_TEL" required/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>传真</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_FAX"/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>邮政编码</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_ZIP"/>
                </span>
            </p>
        </div>
        <div class="easyui-panel form" style="padding:10px" title="扩展信息" border="false" collapsible="true">
            <p class="long-input ue-clear">
                <label>营业执照注册号</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_NUMBER"/>
                </span>
            </p>
            ...
            <p class="long-input ue-clear">
                <label>营业范围</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: C_SCOPE"/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>主营业务收入</label>
                <span class="control">
                    <input data-bind="disable:true,numberboxValue: N_INCOME"/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>固定资产</label>
                <span class="control">
                    <input data-bind="disable:true,numberboxValue: N_ASSETS"/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>特种作业人员</label>
                <span class="control">
                    <input data-bind="disable:true,numberboxValue: N_SPECIAL"/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>专职管理人员</label>
                <span class="control">
                    <input data-bind="disable:true,numberboxValue: N_EMPLOYEE"/>
                </span>
            </p>
            ...
            <p class="long-input ue-clear">
                <label>企业概述</label>
                <span class="control">
                    <input data-bind="disable:true,textareaValue: C_SUMMARY"/>
                </span>
            </p>
        </div>
        <div class="easyui-panel" border="false" style="padding:10px;" title="企业达标情况" collapsible="true">
            <p class="ue-clear">
                <label>达标等级</label>
                <span class="control">
                    <input data-bind="disable:true,textboxValue: T_EXAMINE"/>
                </span>
            </p>
            ...
            <p class="ue-clear">
                <label>下次复审时间</label>
                <span class="control">
                    <input data-bind="disable:true,dateboxValue: T_EXAMINE_NEXT"/>
                </span>
            </p>
        </div>
        <div class="easyui-panel" border="false" style="padding:10px;" title="费用信息" collapsible="true">
            <p class="ue-clear">
                <label>缴费日期</label>
                <span class="control">
