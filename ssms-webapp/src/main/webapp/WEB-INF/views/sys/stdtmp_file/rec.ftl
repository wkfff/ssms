...
<div class="z-toolbar">
    ...
    <a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-undo" onclick="window.location.href = '${BASE_PATH}/?R_SID=${R_SID!folder.SID}'">返回</a>
</div>
<form class="form" method="post">
    ...
    <p class="ue-clear">
        ...
        <span class="control">
            ...
            <#if P_TMPFILE?? && SID??>
                <a href="/sys/stdtmp_file_${P_TMPFILE}/<#if P_TMPFILE=='03'>rec</#if>?sid=${SID}&backURL=${backURL!referer!}">[配置模板]</a></#if>
        </span>
    </p>
