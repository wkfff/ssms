 ...
 <form class="form">
    <div class="group">
        ...
        <table class="content">
            ...
            <tr>
                <td>申请企业</td>
                <td><input type="text" data-bind="disable:true,value: S_ENTERPRISE" readonly/></td>
            </tr>
            <tr>
                <td>单位地址</td>
                <td><input type="text" data-bind="disable:true,value: C_ENTERPRISE_ADDR" readonly/></td>
            </tr>
        </table>
    </div>
    ...
    <div class="group">
        ...
        <table class="content">
            ...
            <tr>
                <td>评审单位</td>
                <td colspan="5"><input type="text" data-bind="disable:true,value: C_REVIEW" readonly/></td>
            </tr>
            <tr>
                <td>单位地址</td>
                <td colspan="5"><input type="text" data-bind="disable:true,value: C_REVIEW_ADDR" readonly/></td>
            </tr>
            <tr>
                <td>评审日期</td>
                <td colspan="5">
                    <input type="text" data-bind="disable:true,dateboxValue: T_START" required style="width: 200px" readonly/>
                    至
                    <input type="text" data-bind="disable:true,dateboxValue: T_END" required style="width: 200px" readonly/>
                </td>
            </tr>
            <tr>
                <td><span class="must">*</span>联系人</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_CONTACT" readonly/></td>
                <td><span class="must">*</span>电话</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_PHONE" readonly/></td>
                <td><span class="must">*</span>传真</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_FAX" readonly/></td>
            </tr>
            <tr>
                <td><span class="must">*</span>手机</td>
                <td><input type="text" data-bind="disable:true,numberboxValue: C_TEL" readonly/></td>
                <td><span class="must">*</span>电子邮箱</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_EMAIL" readonly/></td>
            </tr>
        </table>
    </div>

    <div class="group">
        <h1 class="caption">评审小组成员</h1>

        <table class="content" data-bind="disable:true,with: leader">
            <colgroup>
                <col width="70px"/>
                <col/>
                <col width="70px"/>
            ...
            <tr>
                ...
                <td>
                    <input data-bind="disable:true,comboboxValue:R_MEMBER,comboboxText:S_MEMBER,easyuiOptions:$root.comboConfig" readonly/>
                </td>
                <td>职称</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_JOB_TITLE" readonly/></td>
                <td>电话</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_TEL" readonly/></td>
            </tr>
            <tr>
                <td>备注</td>
                <td><input type="text" data-bind="disable:true,textboxValue: C_REMARK" readonly/></td>
            </tr>
        </table>
        ...
        <table class="content">
            ...
            <tbody data-bind="disable:true,foreach: members">
            <tr>
