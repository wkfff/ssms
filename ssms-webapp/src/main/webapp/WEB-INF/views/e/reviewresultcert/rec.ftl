...
<div class="container">
 <form class="form">
    <table class="content">
        ...
        <tr>
            <td>单位名称</td>
            <td colspan="5"><input type="text" data-bind="disable:true,value: C_ENTERPRISE" readonly/></td>
        </tr>
        <tr>
            <td>等级</td>
            <td><input type="text" data-bind="disable:true,textboxValue: N_LEVEL" readonly/></td>
            <td>行业</td>
            <td><input type="text" data-bind="disable:true,value: S_INSDUTRY" readonly/></td>
            <td>专业</td>
            <td><input type="text" data-bind="disable:true,value: S_PROFESSION" readonly/></td>
        </tr>
        <tr>
            <td>证书编号</td>
            <td colspan="3"><input type="text" data-bind="disable:true,textboxValue: C_CERT_NUMBER" readonly/></td>
            <td>证书状态</td>
            <td>
                <input data-bind="disable:true,comboboxSource:comboState,comboboxValue:N_STATE, easyuiOptions: {valueField:'code',textField: 'name'}" readonly/>
            </td>
        </tr>
        <tr>
            <td>发证机关</td>
            <td colspan="5"><input type="text" data-bind="disable:true,textboxValue: C_ISSUING_AUTHORITY" readonly/></td>
        </tr>
        <tr>
            <td>印制编号</td>
            <td><input type="text" data-bind="disable:true,textboxValue: C_PRINTED_NUMBER" readonly/></td>
            <td>发证日期</td>
            <td><input type="text" data-bind="disable:true,dateboxValue: T_ISSUING_DATE" readonly/></td>
            <td>有效期至</td>
            <td><input type="text" data-bind="disable:true,dateboxValue: T_VALIDITY" readonly/></td>
        </tr>

        <tr>
            <td colspan="6">
                <a href="javascript:void(0);" data-bind="disable:true,uploadOptions: {module: 'ENTERPRISE_CART', sid: '-1'}"></a>
            </td>
        </tr>
    </table>
     </form>
