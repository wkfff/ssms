...
<div id="kocontainer">
    ...
    <form class="form" method="post" data-bind="with: formModel" style="padding:10px 31px; width: 740px">
        <table cellspadding="10" cellspading="10" border="1" style="width: 100%; table-layout: fixed;">
            ...
            <tr>
                <td><span class="must">*</span>设备名称:</td>
                <td>
                    <input data-bind="disable: $parent.readonly, value: C_NAME" />
                </td>
                <td>登记证号:</td>
                <td>
                    <input data-bind="disable: $parent.readonly, value: C_NO_REG"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>制造单位:</td>
                <td>
                    <input data-bind="disable: $parent.readonly, value: C_MAKE_UNIT"/>
                </td>
            </tr>
            ...
            <tr>
                <td><span class="must">*</span>最新检验日期:</td>
                <td>
...
<script type="text/html" id="testTemplate">
    ...
    <p>
    <label for="lastTestTime">最新检验时间:</label>
...
function ViewModel() {
    function FormModel() {
        ...
        this.C_NO_REG=ko.observable('${C_NO_REG!}');
        this.C_SPEC= ko.observable('${C_SPEC!}');
        this.C_MAKE_UNIT= ko.observable('${C_MAKE_UNIT!}');
