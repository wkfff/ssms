<@layout.extends name="../../_layouts/base.ftl">
    ...
    <div class="titlebar">
        ...
        <span class="backing">
        <#if showBack?? && showBack==1><a href="/r/grade/index">返回列表</a></#if>
        </span>
    </div>
    <table class="table">
        <thead>
            ...
            <#if folder.files?size gt 0>
                ...
                <tr id="tr_${file.id}" <#if file.id==sid!"">class="activerow"</#if>>
                    <td><#list 1..level+1 as i>&nbsp;&nbsp;&nbsp;&nbsp;</#list>
                        ...
                        <a href="/r/stdtmp/see/${viewUrl!}-${template.id}-${file.templateFileCode}-${version!0}-${file.id}">${file.name}</a>
                    </td>
                    ...
                    <td class="td_center">
                        <a href="/r/stdtmp/see/${viewUrl!}-${template.id}-${file.templateFileCode}-${version!0}-${file.id}">查看</a>
                    </td>
                </tr>
                </#list>
            </#if>
