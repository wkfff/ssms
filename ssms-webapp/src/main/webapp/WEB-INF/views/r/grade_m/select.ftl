...
<script type="text/javascript">
    ko.applyBindings(new ViewModel(${P_CITY!},${P_COUNTY!},'${C_NAME!}'));
</script>
</#assign>
...
<div id="toolbar">
    ...
    <input class="easyui-combobox" id="cb_county" style="width:140px;" data-bind="comboboxValue:comboCounty,easyuiOptions:comboCountySettings">&nbsp;区/县&nbsp;&nbsp;
         企业名称：<input class="easyui-textbox" id="txt_name" style="width:80px;" data-bind="textboxValue:txtName">
    <input class="easyui-checkbox" type="checkbox" id="chk" data-bind="booleanValue:chkNoComplete">只显示未评审的企业
