    ...
    <div class="group">
        ...
        <table class="content">
            ...
            <tr>
                <td>评审日期</td>
                <td colspan="5">
                    <input type="text" data-bind="dateboxValue: T_START" readonly style="width: 200px"/>
                    至
                    <input type="text" data-bind="dateboxValue: T_END" readonly style="width: 200px"/>
                </td>
            </tr>
            <tr>
                <td><span class="must">*</span>联系人</td>
                <td><input type="text" data-bind="textboxValue: C_CONTACT" readonly/></td>
                <td><span class="must">*</span>电话</td>
                <td><input type="text" data-bind="textboxValue: C_PHONE" readonly/></td>
                <td><span class="must">*</span>传真</td>
                <td><input type="text" data-bind="textboxValue: C_FAX" readonly/></td>
            </tr>
            <tr>
                <td><span class="must">*</span>手机</td>
                <td><input type="text" data-bind="numberboxValue: C_TEL" readonly/></td>
                <td><span class="must">*</span>电子邮箱</td>
                <td><input type="text" data-bind="textboxValue: C_EMAIL" readonly/></td>
            </tr>
        </table>
    </div>
    ...
    <div class="group">
        ...
        <table class="content" data-bind="with: leader">
            ...
            <tr>
                ...
                <td>
                    <input data-bind="comboboxValue:R_MEMBER,comboboxText:S_MEMBER,easyuiOptions:$root.comboConfig" readonly/>
                </td>
                <td>职称</td>
        ...
        <table class="content">
            ...
            <tr>
                ...
                <td>职称</td>
                <td><input type="text" data-bind="textboxValue: C_JOB_TITLE" readonly/></td>
                <td>电话</td>
                <td><input type="text" data-bind="textboxValue: C_TEL" readonly/></td>
            </tr>
            <tr>
                <td>备注</td>
                <td><input type="text" data-bind="textboxValue: C_REMARK" readonly/></td>
            </tr>
            </tbody>
        </table>
    </div>
