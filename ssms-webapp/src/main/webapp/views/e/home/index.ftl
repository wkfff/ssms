    ...
    <div class="frame-head">
        <div class="tY0">
            <h1 class="tG0 sj0" id="h1Logo" style="width:236px;">   
				<a class="rP0" href="javascript:;"><img id="imgLogo" alt="${_TITLE_!"安全生产标准化管理系统"}" src="/resource/images/logo.gif"></a>
			</h1>
            <ul class="js-component-component tO0"> 
                <li class="js-component-component rZ0">
				<a title="" class="sh0  kl0 nui-txt-link" href="javascript:;">欢迎您，<span id="username">${_USERNAME_!""}</span></a>
                </li>
                <li class="js-component-component rZ0 pn1">|</li>
                <li class="js-component-component rZ0 nav__menu-item" id="config">
				<a title="设置" class="sh0  kl0 nui-txt-link" href="javascript:;">设置<b class="js-component-icon kJ0 nui-ico nui-ico-dArr"></b>
				</a>
                ...
                <li class="js-component-component rZ0 pn1">|</li>
                <li class="js-component-component rZ0">
				<a title="帮助" class="sh0  kl0 nui-txt-link" href="javascript:;">帮助<b class="js-component-icon kJ0 nui-ico nui-ico-dArr"></b></a>
                </li>
                <li class="js-component-component rZ0 pn1">|</li>
                <li class="js-component-component rZ0"><a title="" class="sh0 kl0 nui-txt-link" href="javascript:window.location.href='/logout';">退出</a>
                </li>
            </ul>
        </div>
	 ...
	 <div id="dvContentContainer" class="frame-main-outer">
        <div id="dvContainer">
			<div class="frame-main frame-main-noNav">
				<iframe name="frame_main" class="frame-main-cont-iframe" id="frame_main" src="/s/home/task.html" frameborder="0" style="width:100%;height:100%;" allowtransparency="allowtransparency" scrolling="auto"></iframe>
			</div>
		</div>
    </div>
