	...
	<div class="navbar navbar-default navbar-fixed-top"><br><br>
	  <div class="navbar-inner">
	    <form class="navbar-form pull-left form-search">&nbsp;&nbsp;
			<label class="checkbox">企业名称</label>
			<input type="text" name="C_NAME" style="width:60px;" query="C_NAME like ?" />
			<label class="checkbox">省份</label>
			<input type="text" name="S_PROVINCE" style="width:60px;" query="S_PROVINCE = ?"/>
			<label class="checkbox">地市</label>
			<input type="text" name="S_CITY" style="width:60px;" query="S_CITY = ?"/>
			<label class="checkbox"> 县市</label>
			<input type="text" name="S_COUNTY" style="width:60px;" query="S_COUNTY = ?"/>
