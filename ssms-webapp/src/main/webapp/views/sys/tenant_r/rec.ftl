        ...
        $('#formMain').form(
                'submit',
                {
                    ...
                    success : function(data) {
                        ...
                        window.location.href = 'index.html?refer=index&sid='
                                + data.replaceAll('"', '');
                    }
                });
    }
...
<div class="easyui-panel"
    ...
    <a href="#" class="easyui-linkbutton" data-options="plain: true"
        ...
        iconCls="icon-cancel" onclick="doDel()">删除</a> <a href="#"
        class="easyui-linkbutton" data-options="plain: true"
    ...
    <div class="easyui-panel" style="border: 0; margin: 10px"
        ...
        <table>
            ...
            <tr>
                ...
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="C_NUMBER" style="width: 100%" /></td>
                <td class="span2">确定评审业务机关:</td>
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="C_ORG" style="width: 100%" /></td>
            </tr>
            <tr>
                <td class="span2">专职人员:</td>
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="N_FULLTIME" style="width: 100%" /></td>
                <td class="span2">评审专业级别:</td>
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="S_LEVEL" style="width: 100%" /></td>
            </tr>
        </table>
    </div>
    <div class="easyui-panel" style="border: 0; margin: 10px;"
        ...
        <table>
            <tr>
                ...
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="C_TEL" style="width: 100%" /></td>
                <td class="span2">传真:</td>
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="C_FAX" style="width: 100%" /></td>
            </tr>
            <tr>
                <td class="span2">电子邮箱:</td>
                <td colspan="3"><input class="easyui-textbox"
                    type="text" name="C_EMAIL" style="width: 100%" /></td>
            ...
            <tr>
                ...
                <td class="span4"><input class="easyui-textbox"
                    type="text" name="C_ZIP" style="width: 100%" /></td>
            </tr>
        </table>
    </div>
</form>
